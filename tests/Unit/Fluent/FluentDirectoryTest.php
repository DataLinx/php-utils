...
class FluentDirectoryTest extends TestCase
{
    ...
    private static array $test_contents = [
        'test_dir_1',
        'test_dir_1'. DIRECTORY_SEPARATOR .'second_test.md',
        'test_dir_2',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_1',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_2',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_2'. DIRECTORY_SEPARATOR .'nested_dir_A',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_2'. DIRECTORY_SEPARATOR .'nested_dir_B',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_2'. DIRECTORY_SEPARATOR .'nested_dir_B'. DIRECTORY_SEPARATOR .'final_test.md',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_2'. DIRECTORY_SEPARATOR .'just_test.md',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_2'. DIRECTORY_SEPARATOR .'one_more_test.md',
        'test_dir_2'. DIRECTORY_SEPARATOR .'sub_dir_3',
        'test_dir_2'. DIRECTORY_SEPARATOR .'another_test.md',
        'test_dir_2'. DIRECTORY_SEPARATOR .'yet_another_test.md',
        'test_dir_3',
        'test_file.md',
        'test_file_2.md',
    ];
